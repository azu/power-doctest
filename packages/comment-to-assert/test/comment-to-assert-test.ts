...
describe("comment-to-assert", () => {
	describe("when invalid source", () => {
	...
	describe("error messages for comment parsing", () => {
		it("should throw error with line number information for VariableDeclaration", () => {
			assert.throws(
				() => {
					const code = `
                    const a = 1;
		...
		it("should throw error for FunctionDeclaration with assertion comment", () => {
			assert.throws(
				() => {
					const code = `
                    function testFunc() {
		...
		it("should throw error for ClassDeclaration with assertion comment", () => {
			assert.throws(
				() => {
					const code = `
                    class TestClass {
		...
		it("should throw error for ImportDeclaration with assertion comment", () => {
			assert.throws(
				() => {
					const code = `
